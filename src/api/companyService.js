...
export const createCompany = (company, tokenId) => async (dispatch) => {
...
export const updateCompany = (companyId, company, tokenId) => async (dispatch) => {
...
export const removeCompany = (companyId, tokenId) => async (dispatch) => {
